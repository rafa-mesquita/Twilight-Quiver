...
const UPGRADE_BTNS: Array = [
	...
	{"id": "adrenalina", "node": "UpgAdrenalinaBtn", "max": 4, "base_text": "+1 Adrenalina"},
]
...
func _ready() -> void:
	...
	$Content/Scroll/VBox/EnemySection/EnemyContent/ElectricMageBtn.pressed.connect(_spawn.bind("electric_mage"))
...
func _spawn_insect_direct(pos: Vector2 = Vector2.INF) -> void:
	var insect_scene: PackedScene = load("res://scenes/enemies/insect_enemy.tscn")
...
func _open_shop_directly() -> void:
	...
	for n in get_tree().current_scene.get_children():
		if n.scene_file_path == "res://scenes/ui/wave_shop.tscn":
			n.queue_free()
			return
